...
int main() {
	...
	while (p1_m > 0 and p2_m > 0) {
		...
		for (int i = 0; i < 2; i++) {
			...
			if (p1_b == "다이") {
				p1_m -= p1_bm;
				cout << "p2 승리!  p2에게 " << p1_bm << "원 지급";
				p2_m = p2_m + p1_bm + p2_bm;
				break;
			}
			if (p2_b == "콜") {
				p2_bm = p2_bm;
			...
			if (p2_b == "다이") {
				p2_m -= p2_bm;
				cout << "p1 승리!  p1에게 " << p2_bm << "원 지급";
				p1_m = p1_m + p1_bm + p2_bm;
				break;
			}
			cout << "       " << p1_b << "       " << p2_b << endl;
			cout << "배팅금액 : " << p1_bm << "     " << p2_bm << endl;
		...
		if (p1_c[0] == 31 and p1_c[1] == 81) {
			p1_s = 100;
			cout << "삼팔광땡" << "         ";
		}
		if (p2_c[0] == 31 and p2_c[1] == 81) {
			p2_s = 100;
			cout << "삼팔광땡" << endl;
		}
		if (p1_c[0] == 11 and p1_c[1] == 31) {
			p1_s = 98;
			cout << "일삼광땡" << "         ";
			if (p2_c[0] == 42 and p2_c[1] == 72) {
				p2_s = 99;
				cout << "암행어사" << endl;
			}
		}
		if (p1_c[0] == 11 and p1_c[1] == 81) {
			p1_s = 98;
			cout << "일팔광땡" << "         ";
			if (p2_c[0] == 42 and p2_c[1] == 72) {
				p2_s = 99;
		...
		if (p2_c[0] == 11 and p2_c[1] == 31) {
			p2_s = 98;
			cout << "일삼광땡" << endl;
			if (p1_c[0] == 42 and p1_c[1] == 72) {
				p1_s = 99;
				cout << "암행어사" << "         ";
			}
		}
		if (p2_c[0] == 11 and p2_c[1] == 81) {
			p2_s = 98;
			cout << "일팔광땡" << endl;
			if (p1_c[0] == 42 and p1_c[1] == 72) {
				p1_s = 99;
		...
		if (p1_s > p2_s) {
			cout << "             p1 승리!" << endl;
			cout << "p1 에게 " << p1_bm + p2_bm << "원 지급" << endl;
			p1_m = p1_m + p1_bm + p2_bm;
			cout << "남은금액 : " << p1_m << "     " << p2_m << endl;
		}
		if (p1_s < p2_s) {
			cout << "             p2 승리!" << endl;
			cout << "p2 에게 " << p1_bm + p2_bm << "원 지급" << endl;
			p2_m = p2_m + p1_bm + p2_bm;
			cout << "남은금액 : " << p1_m << "     " << p2_m << endl;
		}
		if (p1_s == p2_s) {
